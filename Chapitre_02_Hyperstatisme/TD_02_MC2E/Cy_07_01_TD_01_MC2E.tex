...
\end{center}
\normalsize
Les réponses données dans le tableau sont qulitative et criticable... L'hyperstatisme impose des contraintes dans la fabrication l'assemblage du robot qui peuvent se traduire par des efforts à <<vaincre>> lors de l'assemblage ou de la mise en position du robot. 
