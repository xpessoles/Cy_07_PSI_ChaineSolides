...
\subparagraph{}\textit{Réaliser le graphe de structure.}% en donnant chacune des liaisons et précisant les torseurs cinématiques et statiques. }
\ifprof
\begin{corrige}~\\
\begin{center}
